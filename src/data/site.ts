...
export const eboardMembers = [
  {
    ...
    role: "Sets the direction for BSA, runs meetings, and represents the organization to the university and partners.",
  },
  {
    ...
    role: "Keeps things running behind the scenes. Handles member engagement, meeting logistics, and steps in when the president is away.",
  },
  {
    ...
    role: "Our bridge to the outside. Builds partnerships with other orgs, sponsors, and the Toledo community.",
  },
  {
    name: "Saif Ahmed",
    ...
    role: "Takes care of records, meeting notes, and all the paperwork that keeps BSA organized and on track.",
  },
  {
    ...
    role: "Manages the budget, tracks expenses, handles fundraising, and makes sure every dollar is well spent.",
  },
  {
    ...
    role: "Plans and runs all BSA events, from cultural nights to socials. If there's a venue, a date, and food, he made it happen.",
  },
  {
    ...
    role: "Runs our Instagram, Facebook, and everything online. If you saw a BSA post, she probably made it.",
  },
  {
    ...
    role: "Helps across the board with events, outreach, and member support. Always ready to step up wherever needed.",
  },
  {
    ...
    role: "Supports event planning, community outreach, and makes sure every member's voice is heard.",
  },
];
